...
var cssHelper = (function () {
  ...
  var h = function (v, w, z) {
    ...
    x.onreadystatechange = function () {
      if (x.readyState === 4 && !u) {
        if (
          (!x.status && location.protocol === "file:") ||
        ...
        if (!B && (w === "not" || w === "only")) {
          ...
          if (!B) {
            ...
            if (w.charAt(0) === "(") {
              ...
              x[x.length] = { mediaFeature: y[0], value: y[1] || null };
            }
          }
        }
      }
      ...
      var u = function (E) {
        ...
        h(
          ...
          function (F) {
            F = f(F).replace(
              g.RELATIVE_URLS,
              "url(" + D.substring(0, D.lastIndexOf("/")) + "/$1)",
            );
            E.cssHelperText = F;
            w();
          },
...
domReady(
  (function enableCssMediaQueries() {
    ...
    var j = function () {
      ...
      r.id = s;
      var q = cssHelper.addStyle(
        "@media all and (width) { #" + s + " { width: 1px !important; } }",
        false,
      );
    ...
    var b = function () {
      ...
      f.style.cssText =
        "position:absolute;top:-9999em;left:-9999em;margin:0;border:none;padding:0;width:1em;font-size:1em;";
          ...
          if ("width" === B.substring(r - 5, r)) {
            ...
            if ("height" === B.substring(r - 6, r)) {
              ...
              if ("device-aspect-ratio" === B.substring(r - 19, r)) {
                return (
                  t === "aspect-ratio" &&
                  screen.width * v[1] === screen.height * v[0]
                );
              } else {
    ...
    var m = function (p) {
      ...
      if (v.length > 0) {
        o[o.length] = cssHelper.addStyle(
          "@media " + v.join("") + "{" + p.getCssText() + "}",
          false,
        );
      }
    };
